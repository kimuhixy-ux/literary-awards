...
for award_id, path in AWARD_FILES.items():
    ...
    for r in records:
        ...
        if r.get("theme_summary_en"):
            entry["theme_summary_en"] = r.get("theme_summary_en")
        ...
        if not authors[aid]["country_en"] and r.get("country_en"):
            authors[aid]["country_en"] = r.get("country_en")
    ...
    for e in a["awards"]:
        ...
        if w and w not in seen:
            ...
            works.append({
                ...
                "theme_summary_en": e.get("theme_summary_en"),
            })
